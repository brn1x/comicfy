...
export const SerieContainer = styled.div<SerieContainerProps>`
  display: flex;
...
export const SerieCover = styled.div<SerieContainerProps>`
  width: 100%;
  height: 220px;
  object-fit: cover;
...
export const SerieTitle = styled.h3<SerieContainerProps>`
  width: 100%;
  padding: 8px;
  font-size: 1.1rem;
  font-weight: 500;
